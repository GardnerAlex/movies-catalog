...
exports.MovieDetails = (props) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Typography_1.default, { variant: "h4", component: "h1", className: classes.title }, movie.title),
        react_1.default.createElement(Grid_1.default, { container: true, justify: "center", spacing: 2 },
            react_1.default.createElement(Card_1.default, { className: classes.root },
                react_1.default.createElement(react_router_dom_1.Link, { to: "/test" },
                    react_1.default.createElement(CardMedia_1.default, { className: classes.media, image: `${apiDefaults_1.apiSettings.images.base_url}${apiDefaults_1.apiSettings.images.poster_sizes[6]}${movie.poster_path}`, title: movie.title })),
                ...
                react_1.default.createElement("div", { className: classes.textBox },
                    react_1.default.createElement(Typography_1.default, { variant: "h6" }, movie.title),
                    react_1.default.createElement(Typography_1.default, { variant: "body1" }, movie.overview),
